        ...
        <div className="edit-form">
          ...
          <form>
            <div className="form-group">
              ...
              <input type="text" className="form-control" id="titulo" name="titulo" value={livro.titulo} onChange={trataCampo} />
            </div>
            <div className="form-group mt-3">
              <label htmlFor="description">Autor</label>
              <input type="text" className="form-control" id="autor" name="autor" value={livro.autor} onChange={trataCampo} />
            </div>
          </form>

          <button className="btn btn-warning danger mt-3" onClick={excluirLivro}>
            Excluir
          </button>
